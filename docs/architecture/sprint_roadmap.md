...
| **05** | **Production Infrastructure Refactoring**<br>Migrate to enterprise-grade layout. Move data to HDD, unify Compose files, drop kernel capabilities, and enforce tight security profiles. | • Unified `compose.yaml` (Core + Obs)<br>• Data migration to `/data/docker`<br>• Enforce `cap_drop` and `read_only`<br>• Fully automated HDD Backup script | **DevOps Best Practices**<br>**Data Locality**<br>**Security Hardening** | 1-2 Days | 🏆 **COMPLETED** |
| **06** | **Self-Hosted Applications & Personal Cloud**<br>Deploy essential personal infrastructure over the hardened production base. | • Vaultwarden (Password Manager)<br>• AdGuard Home (Network Adblocker)<br>• Uptime Kuma (Status Monitoring)<br>• Jellyfin (Media Server) | **Docker Compose**<br>**Self-Hosting** | 2-3 Days | ⚪ *Planned* |
| **07** | **AI Inference & GPU Expansion**<br>Integrate future ~60,000 THB AI Server into cluster mesh. Enable local LLMs to act as private cloud co-workers. | • Proxmox VE / Linux AI stack deployment<br>• NVIDIA Container Toolkit configuration<br>• Ollama + Open WebUI<br>• RAG Vector Database integration | **NVIDIA CUDA**<br>**Ollama / vLLM** | Future Build | ⚪ *Planned* |
---
